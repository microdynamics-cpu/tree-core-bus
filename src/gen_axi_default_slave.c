...
//--------------------------------------------------------
int gen_axi_default_slave( char* prefix, int axi4, FILE* fo )
{
    int i=0;
...
fprintf(fo, "//---------------------------------------------------------------------------\n");
fprintf(fo, "`ifndef AXI_DEFAULT_SLAVE_V\n");
fprintf(fo, "`define AXI_DEFAULT_SLAVE_V\n");
    if (axi4) {
fprintf(fo, "`define AXI_DEFAULT_SLAVE_AXI4\n");
    }
fprintf(fo, "module %saxi_default_slave\n", prefix);
    while (code[i] != NULL) {
         fprintf(fo, "%s\n", code[i]);
         i++;
    }
